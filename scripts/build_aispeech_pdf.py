...
def main():
    ...
    named_copies = [
        (p1, os.path.join(OUT_DIR, "李硕研-研发效能与质量平台工程师-常州大学-2027届.pdf")),
        (p1, os.path.join(OUT_DIR, "李硕研-研发效能与质量平台工程师-13091066808.pdf")),
        (p2, os.path.join(OUT_DIR, "李硕研-开源技术研发工程师-常州大学-2027届.pdf")),
        (p2, os.path.join(OUT_DIR, "李硕研-开源技术研发工程师-13091066808.pdf")),
    ]
