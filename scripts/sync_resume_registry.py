...
def sync_registry(conn: sqlite3.Connection) -> dict[str, object]:
    ...
    aispeech_configs = [
        ("aispeech-devops-v1.0", 62, "思必驰科技股份有限公司", "研发效能与质量平台工程师-2027届", "官网校招网申，投递简历：李硕研-研发效能与质量平台工程师-常州大学-2027届.pdf", "官网提交申请，等待简历初筛；对位 CI/CD、自动化测试门禁与质量自检"),
        ("aispeech-opensource-v1.0", 63, "思必驰科技股份有限公司", "开源技术研发工程师-2027届", "官网校招网申，投递简历：李硕研-开源技术研发工程师-常州大学-2027届.pdf", "官网提交申请，等待简历初筛；对位 开源架构、MCP协议、FastAPI与工程规范"),
    ]
    ...
    batch_20260908_configs = [
        # 先导智能 (LEAD)
        ("leadchina-ai-dev-v1.0", 266, "先导智能 (LEAD)", "AI应用开发工程师（2027届校招）(J17813)", "先导智能校招官网", "官网校招网申已完成，投递定制简历《李硕研-先导智能-AI应用开发工程师-常州大学-2027届.pdf》", "官网提交网申，等待初筛；对位NovelMind长文本分层检索系统（L0~L4多粒度向量建模+RAG+FastAPI）"),
        ("leadchina-ai-dev-v1.0", 267, "先导智能 (LEAD)", "软件开发（2027届校招）(J17840)", "先导智能校招官网", "官网校招网申已完成，投递定制简历《李硕研-先导智能-AI应用开发工程师-常州大学-2027届.pdf》", "官网提交网申，等待初筛；对位物联网竞赛与上位机开发经历（PyQt5上位机+串口网口通信调试+Modbus排障）"),
        ("leadchina-ai-dev-v1.0", 268, "先导智能 (LEAD)", "信息安全工程师（2027届校招）(J17810)", "先导智能校招官网", "官网校招网申已完成，投递定制简历《李硕研-先导智能-AI应用开发工程师-常州大学-2027届.pdf》", "官网提交网申，等待初筛；对位计科本科功底与网络安全基础（PKS接口自动化测试+Preflight安全门禁）"),
        # 合合信息 (INTSIG)
        ("intsig-data-crawler-v1.0", 269, "合合信息 (INTSIG)", "27届校招-数据开发工程师(J14428)", "合合信息校招官网", "官网校招网申已完成，投递定制简历《李硕研-合合信息-数据开发工程师-常州大学-2027届.pdf》", "官网提交网申，等待初筛；对标PKS数据挖掘管道（28GB清洗、14,031条SQL血缘映射、数据防篡改门禁）"),
        ("intsig-data-crawler-v1.0", 270, "合合信息 (INTSIG)", "27届校招-爬虫工程师(J14414)", "合合信息校招官网", "官网校招网申已完成，投递定制简历《李硕研-合合信息-数据开发工程师-常州大学-2027届.pdf》", "官网提交网申，等待初筛；命中官方加分项（Codex/Claude Code），对位Wireshark抓包排障与Python网络协议"),
        ("intsig-data-crawler-v1.0", 271, "合合信息 (INTSIG)", "27届校招-数据产品经理（质检方向）(J14410)", "合合信息校招官网", "官网校招网申已完成，投递定制简历《李硕研-合合信息-数据开发工程师-常州大学-2027届.pdf》", "官网提交网申，等待初筛；纯技术底子降维竞聘数据质检产品，SQL数据一致性排查与数据治理经验"),
        # 浩鲸科技 (Whale Cloud)
        ("whalecloud-ai-delivery-v1.0", 272, "浩鲸科技 (Whale Cloud)", "AI应用开发—南京—2027届校招(J18169)", "浩鲸科技校招官网", "官网校招网申已完成，投递定制简历《李硕研-浩鲸科技-AI应用与交付工程师-常州大学-2027届.pdf》", "官网提交网申，等待初筛；主力志愿，对位NovelMind分层长文本向量检索与AI Agent工程落地"),
        ("whalecloud-ai-delivery-v1.0", 273, "浩鲸科技 (Whale Cloud)", "交付工程师—南京—2027届校招(J18084)", "浩鲸科技校招官网", "官网校招网申已完成，投递定制简历《李硕研-浩鲸科技-AI应用与交付工程师-常州大学-2027届.pdf》", "官网提交网申，等待初筛；稳妥保底志愿，对位网络通信协议（TCP/IP、路由交换）与现场排障交付能力"),
    ]
